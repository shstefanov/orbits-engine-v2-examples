...
export default function InstancedMeshBufferExample(){
    ...
    return <>
        ...
        <InstancedMesh
            ...
            instanceBuffer = { useInstanceBuffer(objects) }
        >
        ...
        <a className="source-code-link"
            href="https://github.com/shstefanov/orbits-engine-v2-examples/tree/blob/main/src/examples/objects/InstancedMesBufferhExample.jsx"
        > &lt;SOURCE&gt; </a>
