...
export default function MeshJSONExample(){
    ...
    return <>
        ...
        <MeshLoader
            ...
            onCreate = { mesh => {
                console.log("ANIMATED: ", mesh.toJSON());
            }}
        />
        ...
        <a className="source-code-link"
            href="https://github.com/shstefanov/orbits-engine-v2-examples/tree/blob/main/src/examples/objects/MeshLoaderAnimatedExample.jsx"
        > &lt;SOURCE&gt; </a>
