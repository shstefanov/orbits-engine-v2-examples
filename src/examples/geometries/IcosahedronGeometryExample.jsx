...
import { Mesh, MeshBasicMaterial, IcosahedronGeometry } from "@orbits/engine";
import { input } from "../utils/controlHelpers.jsx";



export default function IcosahedronGeometryExample(){
    ...
    return <>
        ...
        <Mesh>
            <IcosahedronGeometry radius = { radius } detail = { detail } />
        ...
        <a className="source-code-link"
            href="https://github.com/shstefanov/orbits-engine-v2-examples/tree/blob/main/src/examples/geometries/IcosahedronGeometryExample.jsx"
        > &lt;SOURCE&gt; </a>
