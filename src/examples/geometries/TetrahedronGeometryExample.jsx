...
import { Mesh, MeshBasicMaterial, TetrahedronGeometry } from "@orbits/engine";
import { input } from "../utils/controlHelpers.jsx";



export default function TetrahedronGeometryExample(){
    ...
    return <>
        ...
        <Mesh>
            <TetrahedronGeometry radius = { radius } detail = { detail } />
        ...
        <h1>TetrahedronGeometry</h1>

        <a className="source-code-link"
            href="https://github.com/shstefanov/orbits-engine-v2-examples/blob/development/src/examples/geometries/TetrahedronGeometryExample.jsx"
        > &lt;SOURCE&gt; </a>
